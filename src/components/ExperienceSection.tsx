    ...
    <section id="experience" className="section">
      <div className="container-custom">
        <div className="section-title">
          <h2 className="mb-2">{t('Experience & Education')}</h2>
          <p className="text-neutral-600 dark:text-neutral-300 max-w-3xl mx-auto">
            {t('My professional journey and academic background.')}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center mb-8">
              ...
              <h3 className="text-2xl font-semibold">{t('Work Experience')}</h3>
            </div>
                ...
                <div key={index} className="relative pl-12">
                  ...
                  <div className="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-soft hover:shadow-soft-lg transition-all duration-300">
                    <div className="flex justify-between flex-wrap mb-2">
                      <h4 className="text-xl font-semibold text-neutral-800 dark:text-white">{t(exp.title)}</h4>
                      <span className="text-sm font-medium px-3 py-1 bg-primary-50 dark:bg-primary-900/30 text-primary-300 rounded-full">
                        {t(exp.period)}
                      </span>
                    </div>
                    <p className="text-primary-300 font-medium mb-3">{t(exp.company)}</p>
                    <p className="text-neutral-600 dark:text-neutral-300 mb-4">{t(exp.description)}</p>
            ...
            <div className="space-y-8 relative">
              ...
              {education.map((edu, index) => (
                <div key={index} className="relative pl-12">
                  ...
                  <div className="bg-white dark:bg-neutral-800 p-6 rounded-lg shadow-soft hover:shadow-soft-lg transition-all duration-300">
                    <div className="flex justify-between flex-wrap mb-2">
                      <h4 className="text-xl font-semibold text-neutral-800 dark:text-white">{t(edu.degree)}</h4>
                      <span className="text-sm font-medium px-3 py-1 bg-primary-50 dark:bg-primary-900/30 text-primary-300 rounded-full">
                        {t(edu.period)}
                      </span>
                    </div>
                    <p className="text-primary-300 font-medium mb-3">{t(edu.institution)}</p>
                    {edu.description && (
                      <p className="text-neutral-600 dark:text-neutral-300">{t(edu.description)}</p>
                    )}
                  </div>
                </div>
              ))}
